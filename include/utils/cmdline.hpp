  ...
  try
    {
      ...
      TCLAP::SwitchArg arg_coherent_harmonic_sums("", "coherent_harmonic_sums", "Perform coherent harmonic summing (optimal for any duty cycle, but slower).", cmd);
      ...
      args.coherent_harmonic_sums = arg_coherent_harmonic_sums.getValue();
